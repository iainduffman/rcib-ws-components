...
<div class="uk-flex-1 uk-margin-auto">
...
<!-- Social -->
<div uk-grid class="uk-grid-medium uk-flex-middle uk-flex-center uk-grid uk-grid-stack uk-margin-top uk-visible@m">

<ul class="social-icons">

<?php if( get_field('facebook', 'options') ): ?>
<li><a target="_blank"  href="<?php the_field('facebook', 'options'); ?>" class="uk-icon-link" uk-icon="icon: facebook; ratio: 1.5"></a></li>
<?php endif; ?>

<?php if( get_field('twitter', 'options') ): ?>
<li><a target="_blank"  href="<?php the_field('twitter', 'options'); ?>" class="uk-icon-link" uk-icon="icon: twitter; ratio: 1.5"></a></li>
<?php endif; ?>
...
<li><a target="_blank" href="<?php the_field('youtube', 'options'); ?>" class="uk-icon-link" uk-icon="icon: youtube; ratio: 1.5"></a></li>
<?php endif; ?>
</ul>
</div>
<!--   -->
